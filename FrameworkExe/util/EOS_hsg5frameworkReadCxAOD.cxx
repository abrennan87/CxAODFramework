...
int main(int argc, char* argv[]) {
  ...
  //sample_names.push_back("monoWZH");		// Added by ABrennan
  //sample_names.push_back("monoZ");		// Added by ABrennan
  //sample_names.push_back("monoWcon");              // Added by ABrennan
  //sample_names.push_back("monoWdes");              // Added by ABrennan
