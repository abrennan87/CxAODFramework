...
int main(int argc, char* argv[]) {
  ...
  //std::string sample_in="mc14_13TeV.110401.PowhegPythia_P2012_ttbar_nonallhad.merge.AOD.e2928_s1982_s2008_r5787_r5853_tid01597980_00";			// replaced by below, ABrennan
  std::string sample_in="mc14_13TeV.203883.MadGraphPythia8_AU2CTEQ6L1_monoHbb_mx1_xdxhDh.merge.AOD.e3372_s1982_s2008_r5787_r5853_tid04611735_00";	
  ...
  if (!grid) {
    // AOD    
    // 13TeV default
    //SH::DiskListLocal list("/afs/cern.ch/atlas/project/PAT/xAODs/r5787/"+sample_in);			// replaced by below, ABrennan
    SH::DiskListLocal list("/tmp/abrennan/"+sample_in);
    if(comEnergy=="8TeV") {
