...
int main (int argc, char * argv[])
{
	...
	//             Zll,     Wenu,    Wmunu,   Wtaunu,  Zvv,       signal, ttbarall, ttbarnon, singlet,  gammajet,   dijet,  signal
	int color[] = {kWhite, kBlue+1, kBlue+2, kBlue+3, kBlue+4, kBlue+5, kBlue+6, kOrange+1, kOrange+3, kOrange+4, kOrange+5, kOrange+6, kMagenta+1, kMagenta+2, kMagenta+3, kMagenta+4, kMagenta+5, kMagenta+6, kMagenta+7, kMagenta+8, kMagenta+9}; //, kGreen+2, kGreen-3, kGreen-7, kMagenta+3, kRed-9, kRed+2};
	...
	for (int i = 0; i < file_num; i++)
	{
		...
		{   
			...
			hists.back()->Sumw2();				// changed AB, was originally Sumw2(false)
	...
	for (int k = 0; k < stacked_hists.size(); k++)
	{
		...
		stacked_hists.at(k)->Draw("hist");				
		not_stacked_hists.at(k)->Draw("samenostack hist");			
